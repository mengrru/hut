(function () {
    ...
    ***************************************************************************** */
    ...
    var ResolveConfig = (function (configPath) { return __awaiter(void 0, void 0, void 0, function () {
        var userConfig, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    userConfig = _b.apply(_a, [(_c.sent())
                            || ""]);
    ...
    var Route = (function (userConfig) { return __awaiter(void 0, void 0, void 0, function () {
        var DocsDir, HomepagePath, NotFoundPageFullPath, PathQuery, parsePathQuery, Path1, Path2, LoadPath1, pageContent, LoadPath2, pageContent, Load404Page, pageContent;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    DocsDir = userConfig.docsDir;
                    HomepagePath = userConfig.homepage;
                    NotFoundPageFullPath = DocsDir + userConfig.notFoundPage;
                    PathQuery = window.location.search.substring(1).split('&')[0];
                    parsePathQuery = function (query, isFile) {
                    ...
                    Path1 = parsePathQuery(PathQuery, true);
                    Path2 = parsePathQuery(PathQuery, false);
                    return [4 /*yield*/, fetch(Path1)];
                case 1:
                    LoadPath1 = _a.sent();
                    if (!(LoadPath1.status < 400)) return [3 /*break*/, 3];
                    return [4 /*yield*/, LoadPath1.text()];
                case 2:
                    pageContent = _a.sent();
                    return [2 /*return*/, { pageContent: pageContent, status: LoadPath1.status }];
                case 3: return [4 /*yield*/, fetch(Path2)];
                case 4:
                    LoadPath2 = _a.sent();
                    if (!(LoadPath2.status < 400)) return [3 /*break*/, 6];
                    return [4 /*yield*/, LoadPath2.text()];
                case 5:
                    pageContent = _a.sent();
                    return [2 /*return*/, { pageContent: pageContent, status: LoadPath2.status }];
                case 6: return [4 /*yield*/, fetch(NotFoundPageFullPath)];
                case 7:
                    Load404Page = _a.sent();
                    if (!(Load404Page.status < 400)) return [3 /*break*/, 9];
                    return [4 /*yield*/, Load404Page.text()];
                case 8:
                    pageContent = _a.sent();
                    return [2 /*return*/, { pageContent: pageContent, status: 404 }];
                case 9: return [2 /*return*/, { pageContent: "404 Not found", status: 404 }];
            }
        });
    }); });
    ...
    var parseFrontMatter = function (text) {
        ...
        if (text.indexOf('<!--') === 0) {
            ...
            raw.split('\n')
                ...
                var d = e.split(':');
                var key = d[0].replace(' ', '');
                var value = d.slice(1).join('').replace(/^ /, '');
                if (key === "tags") {
                    res[key] = value.split(' ');
                }
                else {
    ...
    var renderFrontMatter = function (frontMatter) {
        var renderedTitle = '';
        var renderedTime = '';
        var renderedTags = '';
        var renderedAbstract = '';
        ...
        var renderedInfo = renderedTime + renderedTags;
        var res = renderedTitle
    ...
    var Renderer = (function (mdRender, routeRes) { return __awaiter(void 0, void 0, void 0, function () {
        var RenderedDOMId, pageContent, status, targetDOM, frontMatterHTML, FullContent, DocTitle, Hash;
        var _a, _b;
        return __generator(this, function (_c) {
            RenderedDOMId = "hut-content";
            pageContent = routeRes.pageContent, status = routeRes.status;
            ...
            frontMatterHTML = renderFrontMatter(parseFrontMatter(pageContent));
            FullContent = "".concat(frontMatterHTML, "\n\n").concat(pageContent);
            document.getElementById(RenderedDOMId).innerHTML = mdRender.render(FullContent);
            DocTitle = (_b = (_a = document.getElementsByClassName('doc-title')) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.textContent;
            document.title = "".concat(DocTitle ? DocTitle + " - " : "").concat(document.title);
    ...
    var LoadTheme = (function (userConfig) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            bodyRenderDOMId = userConfig.renderedDOMId;
            ...
            themeNameFromQueryString = (_a = window.location.search
                .slice(1).split('&')
            ...
            return [2 /*return*/, fetch(themeRootPath + '/body.html')
                    .then(function (res) { return res.text(); })
                    .then(function (data) {
    ...
    (function () { return __awaiter(void 0, void 0, void 0, function () {
        var Dataset, ConfigPath, userConfig, routeRes;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    Dataset = document.currentScript.dataset;
                    ConfigPath = Dataset.config || "config.json";
                    return [4 /*yield*/, ResolveConfig(ConfigPath)];
                case 1:
                    userConfig = _a.sent();
                    return [4 /*yield*/, LoadTheme(userConfig)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, Route(userConfig)];
                case 3:
                    routeRes = _a.sent();
